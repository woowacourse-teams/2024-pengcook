...
VALUES ('김치볶음밥', 1, '00:30:00', '김치볶음밥이미지.jpg', 3, 2, 0, '김치볶음밥 조리법'),
       ('김밥', 1, '01:00:00', '김밥이미지.jpg', 8, 1, 0, '김밥 조리법'),
       ('김치찌개', 1, '00:30:00', '김치찌개이미지.jpg', 3, 2, 0, '김치찌개 조리법'),
       ('토마토스파게티', 1, '00:30:00', '토마토스파게티이미지.jpg', 3, 2, 0, '토마토스파게티 조리법'),
       ('간장계란밥', 1, '00:10:00', '간장계란밥이미지.jpg', 1, 3, 0, '간장계란밥 조리법'),
       ('피자', 1, '00:30:00', '피자이미지.jpg', 3, 2, 0, '피자 조리법'),
       ('된장찌개', 1, '00:30:00', '된장찌개이미지.jpg', 3, 2, 0, '된장찌개 조리법'),
       ('햄버거', 1, '00:30:00', '햄버거이미지.jpg', 3, 2, 0, '햄버거 조리법'),
       ('흰쌀밥', 1, '00:40:00', '흰쌀밥이미지.jpg', 2, 4, 0, '흰쌀밥 조리법'),
       ('샐러드', 1, '00:15:00', '샐러드이미지.jpg', 1, 5, 0, '샐러드 조리법'),
       ('연어스테이크', 1, '00:45:00', '연어스테이크이미지.jpg', 4, 3, 0, '연어스테이크 조리법'),
       ('초콜릿 케이크', 1, '01:20:00', '초콜릿케이크이미지.jpg', 5, 6, 0, '초콜릿 케이크 조리법'),
       ('베지터블 스프', 1, '00:50:00', '베지터블스프이미지.jpg', 3, 2, 0, '베지터블 스프 조리법'),
       ('카레라이스', 1, '00:30:00', '카레라이스이미지.jpg', 3, 2, 0, '카레라이스 조리법'),
       ('새우볶음밥', 1, '00:25:00', '새우볶음밥이미지.jpg', 2, 3, 0, '새우볶음밥 조리법');
